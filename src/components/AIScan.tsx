    ...
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      <div className="grid lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 space-y-6 animate-orbit-in">
          <div className="relative aspect-video lg:aspect-square w-full rounded-2xl border-2 border-dashed border-emerald-500/20 hover:border-emerald-500/40 overflow-hidden bg-black/40 flex flex-col items-center justify-center transition-all animate-quantum shadow-xl">
            ...
            {cameraActive ? (
              <div className="absolute inset-0 flex flex-col justify-between">
                ...
                <div className="absolute bottom-4 left-0 right-0 flex justify-center gap-4 px-4 z-10">
                  <button 
                    ...
                    className="px-6 py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-black font-bold text-sm shadow-lg flex items-center gap-2 cursor-pointer animate-quantum"
                  >
                    <Camera size={18} /> Snap Photo
                  </button>
                  <button 
                    onClick={stopCamera}
                    className="px-6 py-2.5 rounded-xl bg-rose-500/20 border border-rose-500/40 hover:bg-rose-500/30 text-rose-300 font-bold text-sm cursor-pointer animate-quantum"
                  >
                    Cancel
                  </button>
                </div>
              ...
              <div className="p-6 text-center space-y-4">
                <div className="w-16 h-16 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 mx-auto animate-zero-g">
                  <Upload size={28} />
                </div>
                <div>
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
                  <label className="px-5 py-2.5 rounded-xl border border-white/10 hover:border-emerald-500/30 hover:bg-emerald-500/5 text-sm font-semibold transition-all cursor-pointer flex items-center gap-2 justify-center animate-quantum">
                  ...
                  <button 
                    onClick={startCamera}
                    className="px-5 py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-black font-semibold text-sm transition-all cursor-pointer flex items-center gap-2 justify-center shadow-lg shadow-emerald-500/15 animate-quantum"
                  >
