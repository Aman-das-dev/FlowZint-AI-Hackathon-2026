    ...
    <div className="fixed bottom-6 right-6 z-40">
      ...
      {!isOpen && (
        <button
          ...
          className="w-14 h-14 rounded-full bg-gradient-to-tr from-emerald-500 to-teal-400 hover:from-emerald-400 hover:to-teal-300 text-black flex items-center justify-center shadow-xl shadow-emerald-500/20 hover:scale-110 active:scale-95 transition-all cursor-pointer border border-white/10"
      ...
      {/* Chat window panel */}
      {isOpen && (
        <div className="w-80 sm:w-96 h-[500px] rounded-2xl glass-panel border border-white/15 flex flex-col justify-between overflow-hidden shadow-2xl animate-in slide-in-from-bottom duration-300">
